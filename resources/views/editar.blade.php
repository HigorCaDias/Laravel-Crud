...
<body>
    ...
    <form action="/update/{{ $event->id }}" method="post" id="formEdit">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="Estoque" name="Estoque" value="{{ $event->Estoque }}" maxlength="50">
        </div>
        <div class="form-group">
            <label for="title" style="float: left;">CPF/CNPJ/ID</label>
            <input type="text" class="form-control" id="valorPago" name="valorPago" value="{{ $event->valorPago }}" maxlength="14" >
        </div>
        <div class="form-group">
            <label for="title" style="float: left;">Data de Vencimento</label>
            <input type="text" class="form-control" id="valorRevenda" name="valorRevenda" value="{{ $event->valorRevenda }}" >
        </div>
